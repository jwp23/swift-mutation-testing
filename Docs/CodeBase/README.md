...
| [07 — Execution](07-execution.md) | `MutantExecutor`, `ExecutionDeps`, `LikelyKillerTestSelector`, `TestExecutionStage`, `TestExecutionContext`, `BundleSelection`, `BaselineRunner`, `BaselineMeasurement`, `BaselineError`, `MutantTimeout`, `UncompilableMutants`, `TestLaunchResult`, `FallbackExecutor`, `IncompatibleMutantExecutor`, `SimulatorPool`, `SimulatorSlot`, `SimulatorManager`, `SimulatorError`, `MutationCounter`, `RunnerInput`, `ExecutionResult`, `ExecutionStatus` |
